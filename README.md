# template_repo
This repo serves as a template for new repos created in gnlab. Instructions for creating repositories from a template are on [this](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template) github docs page. 
